  ...
  namespace PAR
  {
    ...
    class InelasticDefgradTimeFunctAniso : public InelasticDefgradTimeFunct
    {
     ...
     private:
      ...
      std::unique_ptr<const InelasticDeformationDirection> growth_dir_;
    };
    ...
    class InelasticDefgradPolyIntercalFracAniso : public InelasticDefgradPolyIntercalFrac
    {
     ...
     private:
      ...
      std::unique_ptr<InelasticDeformationDirection> growth_dir_;
    };
  ...
  */
  ...
  class InelasticDefgradLinScalarIso : public InelasticDefgradScalar
  {
   ...
   private:
    ...
    std::unique_ptr<InelasticDefgradLinearShape> linear_growth_;
  };  // namespace Mat
